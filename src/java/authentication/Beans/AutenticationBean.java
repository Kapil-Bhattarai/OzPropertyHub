...
public class AutenticationBean implements Serializable {
    ...
    private Wuser getUserbyEmail() {
        try {
            Wuser user = (Wuser) em.createNamedQuery("Wuser.findByEmail").
    ...
    public String createVerificationCode() {
        ...
        if (usr == null) {
            if (!isValidEmail(email)) {
                FacesContext context = FacesContext.getCurrentInstance();
                FacesMessage message = new FacesMessage("Invliad Email, please try again!");
                context.addMessage(null, message);
                return null;
            }
    ...
    public String genVerificationCode() {
        ...
        Logger.getLogger(AutenticationBean.class.getName()).log(Level.INFO, "Recovery Code: {0}", saltStr);
        return saltStr;
    }
    ...
    public String createUser() {
        ...
        if ((wuser == null) && (euser == null)) {
            ...
            if (!(wuser == null)) {
                ...
                return "emailVerification.faces";
            }
        }
    }
